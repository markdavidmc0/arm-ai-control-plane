...
def test_streamable_mcp():
    print("\033[94m[INFO] Launching local MVCP FastAPI server for streaming integration tests...\033[0m")
    ...
    try:
        ...
        print("\033[92m[SUCCESS] Connection established! Streaming JSON-RPC frames line-by-line:\033[0m")
        print("-" * 80)
        ...
        print("-" * 80)
        if frame_count > 0:
            print(f"\033[92m[SUCCESS] Successfully received {frame_count} streaming frames over a SINGLE connection!\033[0m")
            print("\033[92m[SUCCESS] Streamable HTTP / Newline-Delimited JSON-RPC Gateway is fully verified.\033[0m")
        else:
